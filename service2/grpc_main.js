...
server.addProtoService(service1.Service1.service, {
  echoCall(call, callback) {
    ...
    const span = tracer.startSpan('grpc-service2-span', {
      childOf: parentSpanContext,
      tags: {
        [SPAN_KIND]: 'grpc_service2',
...
server.bind('0.0.0.0:20001', grpc.ServerCredentials.createInsecure());
server.start();
